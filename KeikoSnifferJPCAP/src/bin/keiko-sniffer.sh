...
#
# chkconfig: - 99 01
# description: Keiko Sniffer
# processname: keiko-sniffer
# config: /opt/keiko-sniffer/conf/keiko-sniffer.conf
# pidfile: /opt/keiko-sniffer/run/keiko-sniffer.pid
#
#-----------------------------------------------------------------------------
# These settings can be modified to fit the needs of your application

# Application
APP_NAME="keiko-sniffer"
APP_LONG_NAME="Keiko Sniffer"

# Wrapper
WRAPPER_CMD="/opt/keiko-sniffer/lib/wrapper"
WRAPPER_CONF="/opt/keiko-sniffer/conf/wrapper.conf"
...
# Create PIDDIR directory if it doesn't already exist (some distributions
# delete /var/run on reboot)
mkdir -p $PIDDIR
